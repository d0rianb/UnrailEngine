...
class k {
  ...
  static onMouseClick(t2) {
    Y.addEvent(new k("click", t2, 2));
  }
  static onMouseMove(t2) {
    Y.addEvent(new k("mousemove", t2, 2));
  }
}
const Y = new class {
  constructor() {
...
class lt {
  constructor(t2, e2) {
    ...
    this.id = nt++, this.image = new Image(), this.image.src = t2, this.size = new h(this.image.width, this.image.height), this.rotation = (e2 == null ? void 0 : e2.rotation) || 0, this.offset = (e2 == null ? void 0 : e2.offset) || m, this.scale = (e2 == null ? void 0 : e2.scale) || p;
  }
