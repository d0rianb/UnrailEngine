...
class Xt extends Lt {
  ...
  render() {
    Zt.renderer.circle(this.pos.x, this.pos.y, this.radius, { fillStyle: this.color, lineWidth: 1, globalAlpha: this.opacity / 255 });
  }
}
class Rt {
  constructor(t2, e2, s2, i2) {
...
class Shot extends Lt {
  ...
  render() {
    pt.rect(this.x, this.y, this.width, this.height, { lineWidth: 4, strokeStyle: "red" });
  }
}
class Env extends xt {
  ...
  hit(shot, enemy) {
    ...
    const PG = new Rt(50, new r(shot.x, shot.y), 700, () => {
